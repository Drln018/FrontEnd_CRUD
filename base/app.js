...
const sortProducts = () => {
  ...
  container.innerHTML = ""; // Borra los productos del contenedor
  productList.forEach(addProductsContainer); // Vuelve a cargar los productos ordenados
};

// Manejador del evento click del botón de ordenar
